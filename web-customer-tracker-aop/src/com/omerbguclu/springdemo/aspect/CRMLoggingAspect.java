package com.omerbguclu.springdemo.aspect;
...
public class CRMLoggingAspect {
	...
	@Pointcut("execution(* com.omerbguclu.springdemo.controller.*.*(..))")
	private void forControllerPackage() {}

	// setup pointcut declarations for service package
	@Pointcut("execution(* com.omerbguclu.springdemo.service.*.*(..))")
	private void forServicePackage() {}

	// setup pointcut declarations for dao package
	@Pointcut("execution(* com.omerbguclu.springdemo.dao.*.*(..))")
